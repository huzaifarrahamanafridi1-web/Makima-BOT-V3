...
module.exports = {
  config: {
    ...
    role: 0,
    category: "fun",
    shortDescription: "💙 Luxury Boyfriend Matcher",
    guide: "{p}bf @mention"
  },
  ...
  onStart: async function ({ api, event, usersData }) {
    try {
      ...
      ctx.shadowColor = '#00bfff'; // blue glow
      ctx.shadowBlur = 15;
      ...
      // ===== SAVE =====
      const filePath = path.join(__dirname, "bf_final.png");
